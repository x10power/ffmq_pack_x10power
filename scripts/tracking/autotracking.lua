...
print("---------------------------------------------------------------------")
print("Enable Item Tracking:      ", AUTOTRACKER_ENABLE_ITEM_TRACKING and "ON" or "OFF")
print("Enable Location Tracking:  ", AUTOTRACKER_ENABLE_LOCATION_TRACKING and "ON" or "OFF")
if AUTOTRACKER_ENABLE_DEBUG_LOGGING then
    print("Enable Debug Logging:    ", AUTOTRACKER_ENABLE_DEBUG_LOGGING and "ON" or "OFF")
end
print("---------------------------------------------------------------------")
print("")
